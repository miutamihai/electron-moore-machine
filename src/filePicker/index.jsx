...
export const FilePicker = () => {
    ...
    const {errors: {filePicker: error}, file: {name}} = useContext()

    return <div className={makeContainerClassName(error)}>
        <input type="file" id={'filepicker'} className={ makeClassName(error) } onChange={ onChange }/>
        ...
        <RenderIf condition={!!name}>
            <div className={'flex max-h-full justify-center align-center'}>
